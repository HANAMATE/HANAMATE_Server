...
//        log.info("authentication={}", authentication);
    ...
    @Operation(summary = "대출 정보 가져오기", description = "대출 상품 기본 정보 가져오기(진행중일때) (대출이름, 대출금액, 마감날짜)", tags = {"대출"})
    ...
    @Operation(summary = "대출 상세정보 가져오기", description = "대출 상품 상세 정보 가져오기 (회차, 거래날짜(=상환날짜), 상환금액, 상환 성공여부)", tags = {"대출"})
