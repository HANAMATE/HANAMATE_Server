...
//        initInfo.setCanAmount_3month();
    ...
    public ResponseEntity<?> calculate(LoanRequestDto.Calculate calculate) {

        //TODO: 08.19 민선님 코드 가져와서 작업 수행하기
//      Integer allowance=  allowanceService.getPeriodicAllowance()// ByChildID라는 함수를 가져왔다는 가정으로

//        if (allowance==null){
//              ResponseEntity<?> responseEntity = response.fail(~ 어쩌구)
//          }
        ...
        for(int i=0;i<sequence;i++){
            ...
            month_amount+=interestRates; // 납입원금 + 이자 (총납입금액)
//            total_loanAmount +=month_amount; //총납입금액
        }

//TODO: 08.19 민선님 코드 가져와서 작업 수행하기
        //빌릴 수 있는 최대 금액 계산
//        Integer maxLoanAmount=interestRates+month_amount;
...
//        }
        ...
        calculateResult.setTotal_loanAmount(month_amount);
