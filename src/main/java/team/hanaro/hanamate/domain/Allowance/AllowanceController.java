...
public class AllowanceController {
    ...
    public ResponseEntity<?> GetAllowanceList(@RequestBody AllowanceRequestDto.ChildRequestList childRequestList) {
    ...
    @PostMapping("/request")
    public ResponseEntity<?> MakeAllowanceRequest(@RequestBody AllowanceRequestDto.ChildRequest childRequest) {
    ...
    public ResponseEntity<?> ApproveAllowanceRequest(@RequestBody AllowanceRequestDto.ParentApprove parentApprove) {
